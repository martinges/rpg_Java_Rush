...
public final class PlayerConstraint {
    ...
    public PlayerConstraint() {
    }

    public PlayerConstraint(String name, String title, Race race, Profession profession, Date after, Date before, Boolean banned, Integer minExperience, Integer maxExperience, Integer minLevel, Integer maxLevel) {
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public boolean equals(Object o) {
        ...
        PlayerConstraint that = (PlayerConstraint) o;
